...
public class ResumoActivity extends AppCompatActivity {
    ...
    private void getDadosFormaPagamentos() {
        ...
        ModoPagamento m = ModoPagamentoDAO.getInstance(this).findByIdAuxiliar("codigotipoevento", Constants.PEDIDO.movimentoParcelas.get(0).codigotipoevento);
        linearLayoutPagamento.addView(newTextView(m.descricao));
    }
