...
public class PagamentoSitefModalFragment extends DialogFragment {

    private ModoPagamento modoSelecionado;
    private EditText edtValor;
    private TextView txtValorPendente;

    public static PagamentoSitefModalFragment newInstance() {
        PagamentoSitefModalFragment frag = new PagamentoSitefModalFragment();
        return frag;
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        modoSelecionado = (ModoPagamento) getArguments().getSerializable("modoPagamento");

        builder.setTitle("Confirma pagamento em " + modoSelecionado.descricao + " ?");
            ...
            public void onShow(final DialogInterface dialog) {
                ...
                positiveButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        } else if (value > Misc.fRound(true, Constants.MOVIMENTO.total_pendente, 2) & !modoSelecionado.codigotipoevento.equals(Constants.DTO.registro.listdadosnfce.get(0).codigodinheiro)){
    ...
    private Intent getIntent(Float valor){
        ...
        bundle.putSerializable("modoPagamento", modoSelecionado);
