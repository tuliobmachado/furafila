...
import br.com.informsistemas.furafila.controller.adapter.MovimentoParcelaAdapter;
...
public class MovimentoParcelaFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        movimentoParcela = new MovimentoParcela(Constants.MOVIMENTO.atual, p.codigoforma, p.codigotipoevento, "", valorPago, valorTroco);
